    ...
    def run(self) -> None:
        ...
        **Example Class Usage:**
        ...
        for frame in self.stream.capture_video():
            ...
            # Extract bounding boxes, class IDs, confidence scores and class_scores
            bboxes, class_ids, confidence_scores, class_scores = self.detector.post_process(predictions)

            # Apply Non-Maximum Suppression
            filtered_bboxes, filtered_class_ids, filtered_scores, _ = self.nms.filter(bboxes, class_ids, confidence_scores, class_scores)
