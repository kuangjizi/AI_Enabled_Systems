...
class HardNegativeMiner:
    ...
    def __init__(self, model: Detector, measure: Loss, dataset_dir: str):
        ...
        Internal Process:
        1. The model and loss measure objects are stored as attributes.
    ...
    def __construct_table(self):
        ...
        for i, (image_file, annotation_file) in enumerate(zip(
            ...
            # if i > 100: # TODO: Remove this line to process all images
            #     break
            ...
            table_rows.append({
                ...
                'annotation': self.measure.get_annotations(annotation),  # add annotation to the output table
                **measures})
    ...
    def sample_hard_negatives(self, num_hard_negatives, criteria):
        ...
        return self.table.head(num_hard_negatives), self.table.tail(num_hard_negatives)