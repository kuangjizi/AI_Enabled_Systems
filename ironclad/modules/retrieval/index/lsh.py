...
class FaissLSH:
    ...
    def __init__(self, dim, **kwargs):
        ...
        if self.metric:
            warnings.warn("FAISS LSH does not allow customized distance metric. Default setting applied")
        
        self.index = faiss.IndexLSH(self.dim, kwargs.get("nbits", 128)) # default nbits as 128
